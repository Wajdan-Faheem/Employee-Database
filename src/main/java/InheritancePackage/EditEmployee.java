...
public class EditEmployee extends javax.swing.JFrame {
    ...
    EditEmployeeAdd EEA = new EditEmployeeAdd();
    public MyHashTable theHT = Menu.theHT;
    boolean found = false;  
    public void FindingForEdit(String s){
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts[1].equals(s)&& parts[0].equals("Full-Time")){
                  EEA.jComboBox1.setSelectedItem(parts[0]);
                  EditEmployeeAdd.IEN.setText(parts[1]);
                  EEA.IEEA.setText(parts[2]);
                  EEA.IFN.setText(parts[3]);
                  EEA.ILN.setText(parts[4]);
                  EEA.IEG.setSelectedItem(parts[5]);
                  EEA.IWL.setText(parts[6]);
                  EEA.IDR.setText(parts[7]);
                  EEA.IAS.setText(parts[11]);
                  found = true;
                }
                  ...
                  EEA.IWL.setText(parts[6]);
                  EEA.IDR.setText(parts[7]);
                  EEA.IHW.setText(parts[8]);
                  EEA.IHPW.setText(parts[9]);
                  EEA.IWPY.setText(parts[10]);
                  found = true;
            }
        } 
            reader.close();
    ...
    private void initComponents() {
        ...
        IEE = new javax.swing.JFormattedTextField();
        ...
        ToolLabel.setText("Edit Employee in the System");
        ...
        IEE.setBackground(new java.awt.Color(0, 0, 0));
        IEE.setBorder(null);
        IEE.setForeground(new java.awt.Color(255, 153, 0));
        IEE.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        IEE.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        IEE.addFocusListener(new java.awt.event.FocusAdapter() {
        ...
        IEE.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IEEKeyPressed(evt);
            }
        });
        jPanel1.add(IEE, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 560, 20));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Edit_icon.png"))); // NOI18N
        Edit.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1, -1));
        ...
        GarbageLabel.setText("Edit");
        Edit.add(GarbageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 40, -1));

        jPanel1.add(Edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 90, 90));
    ...
    private void IEEFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_IEEFocusGained
        // TODO add your handling code here
        jSeparator2.setBackground(Color.yellow);
        eN.setForeground(new Color(53,113,177));
    }//GEN-LAST:event_IEEFocusGained

    private void IEEFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_IEEFocusLost
        eN.setForeground(new Color(51,52,54));
    }//GEN-LAST:event_IEEFocusLost

    private void EditMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseExited
        // TODO add your handling code here:
        GarbageLabel.setForeground(Color.white);
        Edit.setBackground(Color.BLACK);
        Edit.setBorder(new LineBorder(Color.WHITE,1,true));
    }//GEN-LAST:event_EditMouseExited

    private void EditMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseEntered
        // TODO add your handling code here:
        GarbageLabel.setForeground(Color.WHITE);
        Edit.setBackground(new Color(255,153,0));
        Edit.setBorder(new LineBorder(new Color(255,153,0),1,true));
    }//GEN-LAST:event_EditMouseEntered

    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
        // TODO add your handling code here:
        // TODO add your handling code here:
        if (IEE.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "FILL IN ALL FIELDS");
        }
        FindingForEdit(IEE.getText().trim());
        if (found == true) {
            theHT.removeFromTable(Integer.parseInt(IEE.getText().trim()));
            EEA.setVisible(true);
            RE.RemoveEmployee(IEE.getText().trim());
            EditEmployee.this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Eployee number is not in the database!");
        }
 ...
 DisplaySystem DS = new DisplaySystem();
    ...
    private void IEEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IEEKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
            if (IEE.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(null, "FILL IN ALL FIELDS");
    ...
    private javax.swing.JFormattedTextField IEE;
