 ...
 */
public class EditEmployeeAdd extends javax.swing.JFrame {
    Menu menu = new Menu();
...
public void SearchInFile(String s){
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(588, 757));
        setMinimumSize(new java.awt.Dimension(588, 757));
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(588, 757));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Save_1.png"))); // NOI18N
        ...
        jPanel1.setBounds(0, 50, 650, 720);
        ...
        jSeparator1.setBounds(50, 40, 210, 10);
        ...
        ExitPanel.setBounds(550, 0, 32, 32);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditEmployeeAdd().setVisible(true);
            }
        });
    }
